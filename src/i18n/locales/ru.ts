...
export const ru: TranslationSchema = {
  ...
  commands: {
    ...
    leaderboard: {
      embeds: {
        footer: "Страница {0} из {1} — Всего участников: {2}",
        level: {
          title: "🏆 Таблица лидеров по уровням",
          description: "Таблица отсортирована по уровням участников.",
          field: {
            name: "**#{0} {1}**",
            value: "Уровень: `{0}` | Опыт: `{1}`",
          },
        },
        voice: {
          title: "🎤 Таблица лидеров по голосовой активности",
          description: "Таблица отсортирована по времени в голосовых каналах.",
          field: {
            name: "**#{0} {1}**",
            value: "Время: `{0}`",
          },
        ...
        coins: {
          ...
          description: "Таблица отсортирована по количеству денег участников.",
          field: {
            name: "**#{0} {1}**",
            value: "Деньги: `{0}`{1}",
          },
    ...
    mod: {
      warn: {
        success: "⚠️ {0} получил(а) предупреждение. Дело **#{1}**",
      },
      unwarn: {
        success: "✅ Дело **#{0}** отменено",
      },
      mute: {
        success: "🔇 {0} получил(а) мут на **{1}**. Дело **#{2}**",
        already: "Этот участник уже в муте",
      },
      unmute: {
        success: "🔊 С {0} снят мут",
        not_muted: "Этот участник не в муте",
      },
      kick: {
        success: "👢 {0} исключён(а) с сервера. Дело **#{1}**",
      },
      ban: {
        success: "🔨 {0} забанен(а). Дело **#{1}**",
        temporary: "🔨 {0} забанен(а) на **{1}**. Дело **#{2}**",
        already: "Этот пользователь уже забанен",
      },
      unban: {
        success: "✅ С {0} снят бан. Дело **#{1}**",
      },
      note: {
        success: "📝 Заметка о {0} добавлена. Дело **#{1}**",
      },
      case: {
        not_found: "Дело **#{0}** не найдено",
      },
      cases: {
        title: "История модерации: {0}",
        empty: "Дел не найдено",
        entry: "`#{0}` **{1}** • <t:{2}:R> • {3}",
        footer: "Страница {0}/{1} • дел: {2}",
      },
      purge: {
        success: "🧹 Удалено сообщений: **{0}**",
        empty: "Нечего удалять",
        too_old: "Сообщения старше 14 дней нельзя удалить массово",
      },
      slowmode: {
        success: "🐌 Медленный режим: **{0}**",
        disabled: "🐌 Медленный режим отключён",
      },
      link: {
        title: "Формы подачи",
        report: "Форма жалобы",
        appeal: "Форма обжалования",
        disabled: "отключена",
        not_configured: "Адрес дашборда не настроен на этом экземпляре бота",
      },
    },
  },
  audit: {
    events: {
      member_join: "Участник {0} ({1}) присоединился к серверу",
      member_leave: "Участник {0} ({1}) покинул сервер",
      member_roles: "Роли участника {0} ({1}) были изменены",
      member_nickname: "Никнейм участника {0} ({1}) был изменён",
      member_ban: "Участник {0} ({1}) был забанен",
      member_unban: "С участника {0} ({1}) снят бан",
      member_kick: "Участник {0} ({1}) был исключён",
      member_timeout: "Участник {0} ({1}) получил тайм-аут",
      message_delete: "Сообщение было удалено",
      message_edit: "Сообщение было отредактировано",
      message_bulk_delete: "Сообщения были удалены массово",
      voice_join: "Участник {0} ({1}) зашёл в голосовой канал {2}",
      voice_leave: "Участник {0} ({1}) покинул голосовой канал {2}",
      voice_move: "Участник {0} ({1}) сменил голосовой канал",
      channel_create: "Канал {0} был создан",
      channel_delete: "Канал {0} был удалён",
      channel_update: "Канал {0} был изменён",
      role_create: "Роль {0} была создана",
      role_delete: "Роль {0} была удалена",
      role_update: "Роль {0} была изменена",
      guild_update: "Настройки сервера были изменены",
    },
    fields: {
      registered: "Дата регистрации",
      roles_added: "Добавлены роли",
      roles_removed: "Удалены роли",
      changed_by: "Кто изменил",
      moderator: "Модератор",
      reason: "Причина",
      author: "Автор",
      channel: "Канал",
      old_nickname: "Старый никнейм",
      new_nickname: "Новый никнейм",
      message: "Удалённое сообщение",
      changes: "Изменения сообщения",
    ...
    footer: {
      member: "ID участника: {0}",
      message: "ID сообщения: {0}",
      channel: "ID канала: {0}",
      role: "ID роли: {0}",
      guild: "ID сервера: {0}",
    },
    unavailable: "содержимое недоступно (сообщения не было в кэше)",
    none: "нет",
    unknown_channel: "неизвестно",
  },
  ...
  moderation: {
    ...
    dm: {
      applied: "Вы получили **{0}** на сервере **{1}**",
      revoked: "Ваше наказание на сервере **{0}** отменено",
      reason: "Причина",
      duration: "Длительность",
      case: "Дело",
    ...
    errors: {
      ...
      hierarchy: "Вы не можете применить это к участнику — его высшая роль не ниже вашей",
      self: "Вы не можете сделать это с собой",
      bot: "Вы не можете сделать это с ботом",
      owner: "Вы не можете сделать это с владельцем сервера",
      member_not_found: "Такого участника нет на сервере",
      user_not_found: "Пользователь не найден",
      invalid_duration: "Неверная длительность. Примеры: `30m`, `2h`, `7d`",
      case_not_found: "Дело **#{0}** не найдено",
      case_inactive: "Дело **#{0}** уже отменено",
      not_banned: "Этот пользователь не забанен",
      action_failed: "Discord отклонил действие: {0}",
    },
    submission: {
      title: "{0} #{1}",
      kinds: {
      ...
      author: "Автор",
      target: "На кого жалоба",
      case: "Дело",
      status: "Статус",
      response: "Ответ",
      handled_by: "Обработал",
      anonymous: "Аноним",
      statuses: {
        pending: "Ожидает",
        in_review: "В работе",
      ...
      modal: {
        approve_title: "Принятие заявки",
        reject_title: "Отклонение заявки",
        response_label: "Ответ автору",
        response_placeholder: "Этот текст будет отправлен автору в личные сообщения",
      },
      dm: {
        approved: "Ваша заявка ({0}) на сервере **{1}** принята",
        rejected: "Ваша заявка ({0}) на сервере **{1}** отклонена",
        response: "Ответ модератора",
      },
      already_handled: "Эта заявка уже обработана",
      not_found: "Заявка не найдена",
      claimed: "{0} взял(а) заявку в работу",
    },
    automod: {
  ...
  events: {
    message_create: {
      ...
      level_up: "Поздравляю, {0}, вы получили новый уровень!",
    },
    interaction_create: {
      cooldown: "Пожалуйста, подождите **{0}с** перед повторным использованием **{1}**",
