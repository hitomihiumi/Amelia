  ...
  commands: {
    ...
    backup: {
      embeds: {
        main: {
          title: "Бэкап сервера",
          description: "Создавайте и восстанавливайте бэкапы сервера. Бэкапы включают роли (с правами и участниками) и каналы (с правами).",
          fields: {
            backups_count: {
        ...
        create: {
          ...
          fields: {
            ...
            info: {
              ...
              value: "• Названия ролей, цвета, права и участники\n• Названия каналов, типы, позиции и права\n• Структура категорий",
            },
          },
        },
        list: {
      ...
      messages: {
        ...
        restore_failed: "Не удалось восстановить бэкап. Некоторые роли или каналы могли не быть созданы.",
        brutal_restored: "💀 Брутальное восстановление **{0}** завершено! Все предыдущие роли и каналы были удалены и воссозданы из бэкапа.",
        brutal_restore_failed: "💀 Брутальное восстановление не удалось. Некоторые роли или каналы могли быть удалены, но не воссозданы. Проверьте права бота.",
