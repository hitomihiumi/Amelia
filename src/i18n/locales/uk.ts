...
export const uk: TranslationSchema = {
  ...
  commands: {
    ...
    mod: {
      warn: {
        success: "⚠️ {0} отримав(ла) попередження. Справа **#{1}**",
      },
      unwarn: {
        success: "✅ Справу **#{0}** скасовано",
      },
      mute: {
        success: "🔇 {0} отримав(ла) мут на **{1}**. Справа **#{2}**",
        already: "Цей учасник уже в муті",
      },
      unmute: {
        success: "🔊 З {0} знято мут",
        not_muted: "Цей учасник не в муті",
      },
      kick: {
        success: "👢 {0} виключено із сервера. Справа **#{1}**",
      },
      ban: {
        success: "🔨 {0} заблоковано. Справа **#{1}**",
        temporary: "🔨 {0} заблоковано на **{1}**. Справа **#{2}**",
        already: "Цього користувача вже заблоковано",
      },
      unban: {
        success: "✅ З {0} знято блокування. Справа **#{1}**",
      },
      note: {
        success: "📝 Нотатку про {0} додано. Справа **#{1}**",
      },
      case: {
        not_found: "Справу **#{0}** не знайдено",
      },
      cases: {
        title: "Історія модерації: {0}",
        empty: "Справ не знайдено",
        entry: "`#{0}` **{1}** • <t:{2}:R> • {3}",
        footer: "Сторінка {0}/{1} • справ: {2}",
      },
      purge: {
        success: "🧹 Видалено повідомлень: **{0}**",
        empty: "Немає чого видаляти",
        too_old: "Повідомлення, старші за 14 днів, не можна видалити масово",
      },
      slowmode: {
        success: "🐌 Повільний режим: **{0}**",
        disabled: "🐌 Повільний режим вимкнено",
      },
      link: {
        title: "Форми подання",
        report: "Форма скарги",
        appeal: "Форма оскарження",
        disabled: "вимкнено",
        not_configured: "Адресу дашборда не налаштовано на цьому екземплярі бота",
      },
    },
  },
  audit: {
    events: {
      member_join: "Учасник {0} ({1}) приєднався до сервера",
      member_leave: "Учасник {0} ({1}) покинув сервер",
      member_roles: "Ролі учасника {0} ({1}) було змінено",
      member_nickname: "Нікнейм учасника {0} ({1}) було змінено",
      member_ban: "Учасника {0} ({1}) заблоковано",
      member_unban: "З учасника {0} ({1}) знято блокування",
      member_kick: "Учасника {0} ({1}) виключено",
      member_timeout: "Учасник {0} ({1}) отримав тайм-аут",
      message_delete: "Повідомлення було видалено",
      message_edit: "Повідомлення було відредаговано",
      message_bulk_delete: "Повідомлення було видалено масово",
      voice_join: "Учасник {0} ({1}) зайшов до голосового каналу {2}",
      voice_leave: "Учасник {0} ({1}) покинув голосовий канал {2}",
      voice_move: "Учасник {0} ({1}) змінив голосовий канал",
      channel_create: "Канал {0} було створено",
      channel_delete: "Канал {0} було видалено",
      channel_update: "Канал {0} було змінено",
      role_create: "Роль {0} було створено",
      role_delete: "Роль {0} було видалено",
      role_update: "Роль {0} було змінено",
      guild_update: "Налаштування сервера було змінено",
    },
    fields: {
      registered: "Дата реєстрації",
      roles_added: "Додані ролі",
      roles_removed: "Видалені ролі",
      changed_by: "Хто змінив",
      moderator: "Модератор",
      reason: "Причина",
      author: "Автор",
      channel: "Канал",
      old_nickname: "Старий нікнейм",
      new_nickname: "Новий нікнейм",
      message: "Видалене повідомлення",
      changes: "Зміни повідомлення",
    ...
    footer: {
      member: "ID учасника: {0}",
      message: "ID повідомлення: {0}",
      channel: "ID каналу: {0}",
      role: "ID ролі: {0}",
      guild: "ID сервера: {0}",
    },
    unavailable: "вміст недоступний (повідомлення не було в кеші)",
    none: "немає",
    unknown_channel: "невідомо",
  },
  ...
  moderation: {
    ...
    dm: {
      applied: "Ви отримали **{0}** на сервері **{1}**",
      revoked: "Ваше покарання на сервері **{0}** скасовано",
      reason: "Причина",
      duration: "Тривалість",
      case: "Справа",
    ...
    errors: {
      ...
      hierarchy: "Ви не можете застосувати це до учасника — його найвища роль не нижча за вашу",
      self: "Ви не можете зробити це із собою",
      bot: "Ви не можете зробити це з ботом",
      owner: "Ви не можете зробити це з власником сервера",
      member_not_found: "Такого учасника немає на сервері",
      user_not_found: "Користувача не знайдено",
      invalid_duration: "Хибна тривалість. Приклади: `30m`, `2h`, `7d`",
      case_not_found: "Справу **#{0}** не знайдено",
      case_inactive: "Справу **#{0}** уже скасовано",
      not_banned: "Цього користувача не заблоковано",
      action_failed: "Discord відхилив дію: {0}",
    },
    submission: {
      title: "{0} #{1}",
      kinds: {
      ...
      author: "Автор",
      target: "На кого скарга",
      case: "Справа",
      status: "Статус",
      response: "Відповідь",
      handled_by: "Опрацював",
      anonymous: "Анонім",
      statuses: {
        pending: "Очікує",
        in_review: "У роботі",
      ...
      modal: {
        approve_title: "Прийняття заявки",
        reject_title: "Відхилення заявки",
        response_label: "Відповідь автору",
        response_placeholder: "Цей текст буде надіслано автору в особисті повідомлення",
      },
      dm: {
        approved: "Вашу заявку ({0}) на сервері **{1}** прийнято",
        rejected: "Вашу заявку ({0}) на сервері **{1}** відхилено",
        response: "Відповідь модератора",
      },
      already_handled: "Цю заявку вже опрацьовано",
      not_found: "Заявку не знайдено",
      claimed: "{0} взяв(ла) заявку в роботу",
    },
    automod: {
