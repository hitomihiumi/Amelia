...
export const en: TranslationSchema = {
  ...
  commands: {
    ...
    modal: {
      ...
      messages: {
        no_fields: "This modal has no fields. Add fields to collect user input.",
      },
    },
    rank: {
    ...
    scenario: {
      ...
      hints: {
        ...
        description:
          "Use these placeholders in your content, embed fields, and DM messages. They will be replaced with actual values when the scenario runs.",
        categories: {
          user: "**👤 User Variables**",
          channel: "**📺 Channel Variables**",
          guild: "**🏠 Server Variables**",
          input: "**📝 Modal Input Variables**",
          selected: "**📋 Select Menu Variables**",
          variables: "**📦 Custom Variables**",
        },
        variables: {
          user_id: "`{user.id}` - User's ID",
          user_name: "`{user.name}` - Username",
          user_displayName: "`{user.displayName}` - Display name",
          user_mention: "`{user.mention}` - User mention (@user)",
          user_avatar: "`{user.avatar}` - Avatar URL",
          channel_id: "`{channel.id}` - Channel ID",
          channel_name: "`{channel.name}` - Channel name",
          channel_mention: "`{channel.mention}` - Channel mention (#channel)",
          guild_id: "`{guild.id}` - Server ID",
          guild_name: "`{guild.name}` - Server name",
          guild_icon: "`{guild.icon}` - Server icon URL",
          input_field: "`{input.0}` - First modal field value (0, 1, 2...)",
          input_label: "`{input.0.label}` - First modal field label",
          selected_value: "`{selected.value}` - Selected option value",
          selected_label: "`{selected.label}` - Selected option label",
  ...
  audit: {
    events: {
      member_join: "Member {0} ({1}) joined the server",
      member_leave: "Member {0} ({1}) left the server",
      member_roles: "Roles of {0} ({1}) were changed",
      member_nickname: "Nickname of {0} ({1}) was changed",
      member_ban: "Member {0} ({1}) was banned",
      member_unban: "Member {0} ({1}) was unbanned",
      member_kick: "Member {0} ({1}) was kicked",
      member_timeout: "Member {0} ({1}) was timed out",
      message_delete: "A message was deleted",
      message_edit: "A message was edited",
      message_bulk_delete: "Messages were deleted in bulk",
      voice_join: "Member {0} ({1}) joined the voice channel {2}",
      voice_leave: "Member {0} ({1}) left the voice channel {2}",
      voice_move: "Member {0} ({1}) switched voice channels",
      channel_create: "Channel {0} was created",
      channel_delete: "Channel {0} was deleted",
      channel_update: "Channel {0} was updated",
      role_create: "Role {0} was created",
      role_delete: "Role {0} was deleted",
      role_update: "Role {0} was updated",
      guild_update: "Server settings were updated",
    },
    fields: {
      registered: "Registered",
      roles_added: "Added roles",
      roles_removed: "Removed roles",
    ...
    unavailable: "content unavailable (the message was not cached)",
    none: "none",
