        ...
        new StringSelectMenuBuilder()
          ...
          .setOptions(
            new StringSelectMenuOptionBuilder()
              ...
              .setDescription(
                t(client, lang, "functions.join_to_create.up_select.options.rename.description"),
              ),
            new StringSelectMenuOptionBuilder()
              ...
              .setDescription(
                t(client, lang, "functions.join_to_create.up_select.options.bitrate.description"),
              ),
            new StringSelectMenuOptionBuilder()
        ...
        new StringSelectMenuBuilder()
          ...
          .setOptions(
            new StringSelectMenuOptionBuilder()
              ...
              .setDescription(
                t(client, lang, "functions.join_to_create.down_select.options.open.description"),
              ),
            new StringSelectMenuOptionBuilder()
              ...
              .setDescription(
                t(client, lang, "functions.join_to_create.down_select.options.close.description"),
              ),
            new StringSelectMenuOptionBuilder()
            ...
            new StringSelectMenuOptionBuilder()
              ...
              .setDescription(
                t(client, lang, "functions.join_to_create.down_select.options.remove.description"),
              ),
            new StringSelectMenuOptionBuilder()
              ...
              .setDescription(
                t(client, lang, "functions.join_to_create.down_select.options.show.description"),
              ),
            new StringSelectMenuOptionBuilder()
              ...
              .setDescription(
                t(client, lang, "functions.join_to_create.down_select.options.hide.description"),
              ),
          ),
      ),
