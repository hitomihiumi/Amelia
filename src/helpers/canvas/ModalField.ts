...
export class ModalField {
  ...
  async render() {
    const canvas = new LazyCanvas().create(400, this.type === "short" ? 100 : 150);
    ...
    canvas.manager.layers.add(
      new Group()
        ...
        .add(
          new MorphLayer().setPosition(200, 65).setSize(400, 250).setColor("#36393f"),
          new MorphLayer().setPosition(200, 65).setSize(380, 50, { all: 5 }).setColor("#313339"),
          new MorphLayer()
            .setPosition(200, 65)
          ...
          new TextLayer()
            ...
            .setColor("#b9bbbe"),
          new TextLayer()
            .setPosition(new Link().setSource("label").setType("width").setSpacing(15), 30)
            .setText("*")
            .setFont(FontsList.Geist_SemiBold(18))
            .setAlign("start")
            .setBaseline("bottom")
      ...
      new Group()
        ...
        .add(
          new MorphLayer().setPosition(200, 90).setSize(400, 250).setColor("#36393f"),
          new MorphLayer().setPosition(200, 90).setSize(380, 100, { all: 5 }).setColor("#313339"),
          new MorphLayer()
            .setPosition(200, 90)
