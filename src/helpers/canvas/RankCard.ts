...
export class RankCard {
  ...
  async render() {
    const canvas = new LazyCanvas({ debug: true }).create(800, 350);
    ...
    canvas.manager.layers.add(
      ...
      new MorphLayer().setPosition(155, 265).setSize(180, 40, { all: 5 }).setColor("#f1f1f1"),
      new TextLayer()
        .setPosition(155, 265)
      ...
      new ImageLayer().setPosition(85, 265).setSize(27, 35).setSrc(assetsMap.microphone),
      new ImageLayer()
        .setPosition(155, 135)
